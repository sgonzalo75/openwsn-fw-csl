...
#include "../02a-MAClow/IEEE802154Ecsl.h"
...
void openqueue_reset_entry(OpenQueueEntry_t* entry) {
   ...
   entry->l2_nextORpreviousHop.addr_128b[3]  = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[4]  = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[5]  = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[6]  = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[7]  = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[8]  = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[9]  = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[10] = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[11] = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[12] = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[13] = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[14] = 0x00;
   entry->l2_nextORpreviousHop.addr_128b[15] = 0x00;

   entry->l2_nextORpreviousHop.addr_64b[0]   = 0x00;
   entry->l2_nextORpreviousHop.addr_64b[1]   = 0x00;
   entry->l2_nextORpreviousHop.addr_64b[2]   = 0x00;
   entry->l2_nextORpreviousHop.addr_64b[3]   = 0x00;
   entry->l2_nextORpreviousHop.addr_64b[4]   = 0x00;
   entry->l2_nextORpreviousHop.addr_64b[5]   = 0x00;
   entry->l2_nextORpreviousHop.addr_64b[6]   = 0x00;
   entry->l2_nextORpreviousHop.addr_64b[7]   = 0x00;

   entry->l2_nextORpreviousHop.addr_16b[0]   = 0x00;
   entry->l2_nextORpreviousHop.addr_16b[1]   = 0x00;

   entry->l2_nextORpreviousHop.panid[0]      = 0x00;
   entry->l2_nextORpreviousHop.panid[1]      = 0x00;

   entry->l2_nextORpreviousHop.prefix[0]     = 0x00;
   entry->l2_nextORpreviousHop.prefix[1]     = 0x00;
   entry->l2_nextORpreviousHop.prefix[2]     = 0x00;
   entry->l2_nextORpreviousHop.prefix[3]     = 0x00;
   entry->l2_nextORpreviousHop.prefix[4]     = 0x00;
