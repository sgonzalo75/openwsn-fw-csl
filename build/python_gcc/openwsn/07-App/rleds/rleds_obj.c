...
This was done on 2014-10-04 20:16:09.666522.
*/
/**
...
owerror_t rleds_receive(OpenMote* self, 
   OpenQueueEntry_t* msg,
   coap_header_iht*  coap_header,
   coap_option_iht*  coap_options
);
void rleds_sendDone(OpenMote* self, 
   OpenQueueEntry_t* msg,
   owerror_t error
);
...
void rleds__init(OpenMote* self) {
 ...
 opencoap_register(self, &rleds_vars.desc);
}
...
*/
void rleds_sendDone(OpenMote* self, OpenQueueEntry_t* msg, owerror_t error) {
