...
enum IEEE802154_fcf_type_enums {
   ...
   IEEE154_TYPE_ACK                    = 2,
   IEEE154_TYPE_CMD                    = 3,
   IEEE154_TYPE_LLDN				   = 4, // Aunque no se usará, definimos el tipo de trama LLDN.
   IEEE154_TYPE_MULTIPURPOSE           = 5, // Segun norma, el frame type es 101 (5) para tramas multipurpose
   IEEE154_TYPE_UNDEFINED              = 6, // SERGIO - Modificado
};
...
void ieee802154_retrieveWakeUpHeader(OpenQueueEntry_t*      msg,
                                     ieee802154_header_iht* ieee802514_header,
									 uint16_t* rztime);
